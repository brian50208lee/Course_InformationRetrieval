package ire.project1.topicmodel.demo;
...
import ire.project1.topicmodel.plsa.PLSAModel;
import ire.project1.topicmodel.struct.BidirectionalIndexMap;

public class DemoPLSA {
	...
	private static final String QRYS_PATH = "/Users/selab/git/Course_InformationRetrieval/ParsedData/5000relevantQry.txt/";
	private static final String RESULT_PATH = "/Users/selab/Desktop/result.csv";
	private static final int RELEVANT_DOC_NUM = 400;
	...
	private static PLSAModel model;
	...
	public static void main(String[] args) throws IOException {
		...
		for (String query[] : queryList) {//each query
			...
			/* create model */
			model = new PLSAModel(documentTermMatrix, 150, 30);
			model.training();
